...
extern const struct linux_logo logo_1920_clut224;
extern const struct linux_logo logo_mik_clut224;
extern const struct linux_logo logo_cat_clut224;

extern const struct linux_logo *fb_find_logo(int depth);
extern const struct linux_logo *fb_find_user_logo(int select);
